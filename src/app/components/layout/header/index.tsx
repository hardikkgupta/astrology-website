                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-3">
                                            <Link href={"/contact"} className="flex justify-center items-center gap-2 w-full text-white text-xl font-bold rounded-full bg-secondary py-2 px-4.5 hover:bg-secondary/90">
                                                Contact Us
                                            </Link>
                                        </div>
                                    </div>
