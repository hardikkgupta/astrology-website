            ...
            <div className="dark:bg-darkblack">
                <div className="container">
                    <div className='flex flex-col py-10 md:py-20'>
                        <p >
                            These Terms of Service (“<span className="font-semibold">Agreement</span>”) are entered into by and between our company (“<span className="font-semibold">Company</span>”) and the entity or person placing an order for or accessing the services (“<span className="font-semibold">Customer</span>”). This Agreement consists of the terms and conditions set forth below and any Order Form. The “<span className="font-semibold">Effective Date”</span> of this Agreement is the date which is the earlier of (a) Customer’s initial access to the services through any online provisioning, registration or order process or (b) the Effective Date of the first Order Form. This Agreement will govern Customer’s initial purchase on the Effective Date as well as any future purchases made by Customer that reference this Agreement. The Company may modify this Agreement from time to time as permitted in Section 13.4 (Amendment).
                        </p>
                        <p className="mt-5 ">
